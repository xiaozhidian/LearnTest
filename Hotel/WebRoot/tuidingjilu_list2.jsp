...
//txixixngdy
    ...
    String url = "tuidingjilu_list2.jsp?1=1"; 
    String sql =  "select * from tuidingjilu where tuidingren='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="tuidingjilu_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="tuidingjilu_list2.jsp?scid=<%=map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a> <a href="tuidingjilu_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
