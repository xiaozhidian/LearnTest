...
//txixixngdy
    ...
    String url = "ruzhuxinxi_list2.jsp?1=1"; 
    String sql =  "select * from ruzhuxinxi where ruzhuren='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td width="138" align="center"><%=map.get("addtime") %></td>
    <td width="60" align="center"><a href="ruzhuxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
