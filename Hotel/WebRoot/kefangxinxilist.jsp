...
<table width="992" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <%@ include file="qtleft.jsp"%></td>
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit5" value="切换视图"  style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='kefangxinxilisttp.jsp';" />
</form>
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="30" align="center"> <a href="kefangxinxidetail.jsp?id=<%=map.get("id")%>" >详细</a></td>
  </tr>
  	<%
  }
   %>
