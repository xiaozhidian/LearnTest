...
response.addHeader("Content-Disposition", "attachment;filename=yudingxinxi.xls");
%>
<html>
  <head>
    <title>预定信息</title>
...
//youzuiping2
  ...
  <tr>
    ...
    <td width='80' align='center'><a href="sh.jsp?id=<%=map.get("id")%>&yuan=<%=map.get("issh")%>&tablename=yudingxinxi" onclick="return confirm('您确定要执行此操作？')"><%=map.get("issh")%></a></td>
