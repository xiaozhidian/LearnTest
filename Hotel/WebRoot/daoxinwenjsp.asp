...
<%
connstr="DRIVER={SQL Server};Server=.;UID=sa;PWD=sa123456;DATABASE=jspmjdydxt0534;"
...
<body>
<%
sql="select top 15  * from allgonggao where title like '%优惠%' or leibie like '%优惠%' order by newid()"
